...
export default function PageNavigation() {
  ...
  const getQuickNavItems = () => {
    ...
    const baseItems = [
      ...
      { label: "Calendário", icon: Calendar, path: "/app/calendar" },
    ...
    if (user.role === "teacher") {
      return [
        ...
        { label: "Turmas", icon: Users, path: "/app/teacher/classes" },
        { label: "Comunicação", icon: MessageSquare, path: "/app/teacher/communication" },
        ...baseItems.slice(1), // Calendar, Settings
      ];
    } else {
      return [
        ...baseItems.slice(0, 1), // Dashboard
        { label: "Desempenho", icon: BarChart3, path: "/app/performance" },
